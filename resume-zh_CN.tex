...
\contactInfo{(+86) 123-4567-8901}{xxx@xxx.com}{Web前端研发工程师}{}
% {E-mail}{mobilephone}
...
\section{实习经历}
技术栈：\techlist{Java, Python, Docker, Kubernetes, AWS}
\datedsubsection{\textbf{XXXX集团 | XXXXX}, 前端开发工程师}{2011-2017}
\begin{itemize}
  \item 北京前端团队全面负责 \mcode{web} 应用与基础架构框架研发
  \item 独立负责 XX 需求(\mcode{React}),通过 \mcode{HTML5} 本地存储及 \mcode{JSBridge} 实现在XXX发布上线
